...
class AdminController {
    ...
    public function resetData(Request $req) {
        ...
        // Channels are preserved (config), but their per-lane RUNTIME state must
        // reset too, or a stuck blocker cycle / stale heartbeat survives the wipe
        // and keeps the lane busy / shows a false online.
        Database::query(
            "UPDATE anprc_channels SET blocker_cycle = 'idle', blocker_sensor = 'clear', blocker_last_seen = NULL"
        );
