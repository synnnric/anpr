...
const ACTION_LABELS: Record<string, { id: string; en: string }> = {
  ...
  xray_receipt:          { id: 'Receipt X-Ray', en: 'X-Ray receipt' },
  xray_review_pass:      { id: 'X-Ray diizinkan', en: 'X-Ray passed' },
  xray_review_deny:      { id: 'X-Ray ditolak', en: 'X-Ray denied' },
  route_to_xray:         { id: 'Diarahkan ke X-Ray', en: 'Routed to X-Ray' },
  come_blacklist_xray:   { id: 'Blacklist → X-Ray', en: 'Blacklist → X-Ray' },
  orphan_exit_allowed:   { id: 'Orphan exit diizinkan', en: 'Orphan exit allowed' },
  orphan_exit_denied:    { id: 'Orphan exit ditolak', en: 'Orphan exit denied' },
  orphan_exit_paired:    { id: 'Orphan exit dipasangkan', en: 'Orphan exit paired' },
  come_xray_cleared:     { id: 'Masuk (X-Ray clear)', en: 'Entry (X-ray cleared)' },
  come_xray_flagged:     { id: 'Masuk DITANDAI (X-Ray ditolak)', en: 'Entry FLAGGED (X-ray denied)' },
  xray_room_come:        { id: 'Gerbang ruang X-Ray', en: 'X-ray room gate' },
  come_whitelist_xray:   { id: 'Non-whitelist → X-Ray', en: 'Non-whitelist → X-Ray' },
  manual_admit:          { id: 'Masuk manual (operator)', en: 'Manual admit (operator)' },
  ...
  'location.create':     { id: 'Tambah lokasi', en: 'Create location' },
  'location.delete':     { id: 'Hapus lokasi', en: 'Delete location' },
