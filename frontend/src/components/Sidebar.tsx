import {
  ...
  History, SlidersHorizontal, Crown, Ban, type LucideIcon,
} from 'lucide-react';
...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'vip', labelKey: 'nav.vip', icon: Crown },
      { id: 'plate-blacklist', labelKey: 'nav.blacklist', icon: Ban },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'api-log', labelKey: 'nav.api_log', icon: Activity },
